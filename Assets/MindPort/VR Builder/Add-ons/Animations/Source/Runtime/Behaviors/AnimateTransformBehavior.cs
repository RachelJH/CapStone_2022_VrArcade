...
namespace VRBuilder.Animations.Behaviors
{
    ...
    public class AnimateTransformBehavior : Behavior<AnimateTransformBehavior.EntityData>
    {
        ...
        public AnimateTransformBehavior(ISceneObject target, ISceneObject transformProvider, float duration, AnimationCurve positionCurve, AnimationCurve rotationCurve, AnimationCurve scaleCurve, bool pingPong = false, int repeats = 1, string name = "Animate Transform") : this(ProcessReferenceUtils.GetNameFrom(target), ProcessReferenceUtils.GetNameFrom(transformProvider), duration, positionCurve, rotationCurve, scaleCurve, pingPong, repeats, name)
        {
        }

        public AnimateTransformBehavior(string targetName, string transformProviderName, float duration, AnimationCurve positionCurve, AnimationCurve rotationCurve, AnimationCurve scaleCurve, bool pingPong = false, int repeats = 1, string name = "Animate Transform")
        {
