...
namespace VRBuilder.Editor.Randomization.DemoScene
{
    /// <summary>
    ...
    {
        private const string demoScenePath = "Assets/MindPort/VR Builder/Add-ons/Randomization/Demo/Scenes/VR Builder Demo - Randomization.unity";
        private const string demoProcessOrigin = "Assets/MindPort/VR Builder/Add-ons/Randomization/Demo/StreamingAssets/Processes/Demo - Randomization/Demo - Randomization.json";
        private const string demoProcessDirectory = "Assets/StreamingAssets/Processes/Demo - Randomization";
        private const string demoProcessDestination = "Assets/StreamingAssets/Processes/Demo - Randomization/Demo - Randomization.json";
