...
namespace CircularGravityForce
{
    ...
    public class CGF_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(forceType_property.enumValueIndex != (int)CGF.ForceType.Velocity &&
               forceType_property.enumValueIndex != (int)CGF.ForceType.AngularVelocity)
            {
                /*<----------------------------------------------------------------------------------------------------------*/
                EditorGUI.BeginChangeCheck();
        ...
        void OnSceneGUI()
        {
            ...
            if (cgf._drawGravityProperties.DrawGizmo)
            {
                ...
                switch (cgf._shape)
                {
                    case CGF.Shape.Sphere:
                        ...
                        if ((cgf._forceType == CGF.ForceType.ForceAtPosition ||
                            ...
                            cgf._forceType == CGF.ForceType.Velocity ||
                        ...
                        else if (cgf._forceType == CGF.ForceType.Torque || cgf._forceType == CGF.ForceType.AngularVelocity)
                        {
                        ...
                        if (cgf._forceType != CGF.ForceType.Torque && cgf._forceType != CGF.ForceType.AngularVelocity)
                        {
                            if (cgf._forcePositionProperties.ForcePosition == CGF.ForcePosition.ThisTransform)
                            {
                ...
                if(counterGravity_property.boolValue)
                {
                    ...
                    Handles.Label(labelPos, string.Format("Gravity -= {0}", (Physics.gravity * cgf.CounterGravityMultiplier)), centeredStyle);
                }
            }
