...
public class Zombie : LivingEntity {
    ...
    */
    ...
    private IEnumerator UpdatePath() {
        ...
        while (!dead)
        {
            Debug.Log("UpdatePath !dead");
            if (hasTarget)
            {

                Debug.Log("UpdatePath hasTarget");
            ...
            else
            {
                ...
                {
                    Debug.Log("targeting for");
                    // 콜라이더로부터 LivingEntity 컴포넌트 가져오기
                    LivingEntity livingEntity = colliders[i].GetComponent<LivingEntity>();
                    if(livingEntity == null) Debug.Log("lE Null");
                    if (livingEntity == dead) Debug.Log("lE dead");
